  ...
  return (
    <Box textAlign="left" ml={300} m={100}>
      ...
      <Text>
        ...
        and any related services provided by imgs.bar.
      </Text>
      <br></br>
      <Text>
        By accessing{' '}
        ...
        using any other services provided by imgs.bar.
      </Text>
      <br></br>
      <Text>
        We,{' '}
        ...
        , reserve the right to review and amend any of these Terms of Service at
        our sole discretion. Upon doing so, we will update this page. Any
        changes to these Terms of Service will take effect immediately from the
        date of publication.
      </Text>
      <br></br>
      <Text>These Terms of Service were last updated on 28/06/21.</Text>
      ...
      <Text>
        ...
        and are protected by applicable copyright and trademark law.We grant our
      ...
      <Text>
        ...
        use this website or the materials on this website, even if{' '}
        <Link color="blue.300" href="/">
          imgs.bar
        </Link>{' '}
        or an authorized representative has been notified, orally or in writing,
      ...
      <Text>
        ...
        any link does not imply endorsement, approval, or control by{' '}
        <Link color="blue.300" href="/">
          imgs.bar
        </Link>{' '}
      ...
      <Text>
        ...
        the laws of Canada. You irrevocably submit to the exclusive jurisdiction
