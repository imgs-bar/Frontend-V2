...
const ok = () => {
  ...
  <TabPanels>
    ...
    <br></br>
    <Avatar name="Flame" ml={655} mt={0} bg="none" size="2xl" src="https://cdn.discordapp.com/avatars/417330353917657100/a_09774470b970a3290ccf1d5043d33cd1.gif?size=256&f=.gif" />
    <Text fontSize={20} ml={690} mt={5}>Flame</Text>
